...
<head>
    ...
    <title>Infos Huile d'Olive</title>
</head>
<body>
    <button class="Returns" type="submit"><a class="ReturnsLinks" href="Matières premières.php">Retour</a></button>
    <br>
    <video controls autoplay>
        <source src="../HuilesEssentiellesVideo/VideoClipHuiledOlive.mp4">
    </video>
    <div class="InfosMatPrem">
        <figure>
            <img class="Supplies" src="Images/HuilesVégétales/huile_d'olive.jpg" title="Huile d'Olive">
            <figcaption>Huile d'Olive</figcaption>
        </figure>
        <div class="TextMatPrem">
            <p class="Produits">Qu'est ce que l'huile d'Olive ?</p> 
            <br>
