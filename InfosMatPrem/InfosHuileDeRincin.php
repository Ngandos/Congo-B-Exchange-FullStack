...
<head>
    ...
    <title>Infos Huile De Ricin</title>
</head>
<body>
    <button class="Returns" type="submit"><a class="ReturnsLinks" href="Matières premières.php">Retour</a></button>
    <br>
    <video controls autoplay>
        <source src="../HuilesEssentiellesVideo/VideoClipHuiledeRincinHD.mp4">
    </video>
    <div class="InfosMatPrem">
        <figure>
            <img class="Supplies" src="../Images/Articles/HuileDeRicinConditionnee/huile_de_ricin_pot_150ml_dessus.JPG" title="Huile de Ricin">
            <figcaption>Huile de Ricin</figcaption>
        </figure>
        <div class="TextMatPrem">
            <p class="Produits">Qu'est ce que l'huile de ricin ?</p> 
            <br>
